...
"""
  ...
  vibrational modes can be calculated (mode = 1). mode = 2 combines the two 
  other modes (only usefule if aims-binary is provided). Only the atoms  
  without constrain_relaxation .true. in geometry.in will be   displaced. 
